...
corresponding major mode!) in [[info:eww#Top][EWW]], [[https://github.com/wasamasa/nov.el][nov.el]] or any other packrce that renders HTML
content with the library ~shr~.
